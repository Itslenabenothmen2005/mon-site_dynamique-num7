...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 16 mai 2024 à 18:43
...
INSERT INTO `region` (`NumReg`, `NomReg`) VALUES
(1, 'Kairouan'),
(2, 'Ile kuriat'),
(3, 'El Fahs'),
(4, 'Sidi Bousaid');
...
ALTER TABLE `seisme` ADD CONSTRAINT `fk2` FOREIGN KEY (`NumReg`) REFERENCES `region`(`NumReg`) ON DELETE CASCADE ON UPDATE CASCADE; 
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `seisme`
  ADD CONSTRAINT `fk2` FOREIGN KEY (`NumReg`) REFERENCES `region` (`NumReg`) ON DELETE CASCADE ON UPDATE CASCADE,
